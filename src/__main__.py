...
from .indexing import index_files, chromadb_indexing, files_mtime
...
class Rag:
    ...
    def answer_dataset(self, student_search_results_path, save_directory="data/output"):
        
        output_path = save_directory + "/" + Path(student_search_results).name
